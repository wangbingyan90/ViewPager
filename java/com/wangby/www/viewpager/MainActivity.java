package com.wangby.www.viewpager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置tab的背景色
        pagertabStrip.setBackgroundColor(this.getColor(R.color.colorPrimary));
        //设置当前tab页签的下划线颜色
        pagertabStrip.setTabIndicatorColor(this.getResources().getColor(R.color.colorAccent));
        ...
        View view4 = LayoutInflater.from(this).inflate(R.layout.tab, null);
        //viewpager开始添加view
